...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (BuildContext context, GoRouterState state) {
      ...
      // Protected routes in consumer mobile app
      final isProtected = location.startsWith('/profile') ||
      ...
      if (!isAuth && isProtected) {
        return '/login?redirectTo=${Uri.encodeComponent(location)}';
      }

      if (isAuth && isAuthScreen && location != '/onboarding') {
        return '/';
      }
