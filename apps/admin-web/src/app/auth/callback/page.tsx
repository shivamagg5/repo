  ...
  if (errorMsg) {
    return (
      <div className="min-h-screen bg-[#0A0C10] flex flex-col items-center justify-center p-4">
        <div className="bg-[#12151D] border border-red-800 rounded-2xl p-8 max-w-md w-full text-center">
          <h2 className="text-xl font-bold text-white mb-2">Authentication Failed</h2>
          <p className="text-sm text-gray-400 mb-6">{errorMsg}</p>
          <a
            href="/auth/login"
            className="inline-flex justify-center py-2.5 px-5 rounded-xl text-sm font-semibold text-white bg-red-600 hover:bg-red-500 transition-colors"
          >
            Back to Sign In
          </a>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#0A0C10] flex flex-col items-center justify-center p-4">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-sm font-medium text-gray-300">Verifying administrator session...</p>
      </div>
    </div>
  );
}
